...
## Clock signal
set_property CLOCK_DEDICATED_ROUTE FALSE -dict { PACKAGE_PIN E3 IOSTANDARD LVCMOS33 } [get_ports { input_clk }]; #IO_L12P_T1_MRCC_35 Sch=input_clk
...
set_property -dict { PACKAGE_PIN N17 IOSTANDARD LVCMOS33 } [get_ports { btn[0] }]; #IO_L9P_T1_DQS_14 Sch=btn
set_property -dict { PACKAGE_PIN M18 IOSTANDARD LVCMOS33 } [get_ports { btn[1] }]; #IO_L4N_T0_D05_14 Sch=btn
set_property -dict { PACKAGE_PIN P17 IOSTANDARD LVCMOS33 } [get_ports { btn[2] }]; #IO_L12P_T1_MRCC_14 Sch=btn
set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVCMOS33 } [get_ports { btn[3] }]; #IO_L10N_T1_D15_14 Sch=btn
set_property -dict { PACKAGE_PIN P18 IOSTANDARD LVCMOS33 } [get_ports { btn[4] }]; #IO_L9N_T1_DQS_D13_14 Sch=btn
...
##USB-RS232 Interface
set_property -dict { PACKAGE_PIN C4 IOSTANDARD LVCMOS33 } [get_ports { RsTx }]; #IO_L7P_T1_AD6P_35 Sch=RsTx
set_property -dict { PACKAGE_PIN D4 IOSTANDARD LVCMOS33 } [get_ports { RsRx }]; #IO_L11N_T1_SRCC_35 Sch=RsRx
